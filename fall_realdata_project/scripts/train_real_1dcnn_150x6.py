...
def build_model() -> tf.keras.Model:
    ...
    x = conv_block(inputs, 32, kernel_size=7, pool_size=2, dropout_rate=0.15)
    x = conv_block(x, 64, kernel_size=5, pool_size=2, dropout_rate=0.20)
    x = conv_block(x, 128, kernel_size=3, pool_size=2, dropout_rate=0.20)
    x = conv_block(x, 128, kernel_size=3, pool_size=None, dropout_rate=0.15)
    ...
    # TODO: Label Smoothing sauber mit One-Hot-Labels testen. Aktuell bleiben
    # sparse Labels erhalten, damit class_weight, Evaluation und Confusion Matrix
